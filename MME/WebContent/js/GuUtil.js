...
GuUtil.prototype.setEle = function(_ele, _target )
{
	var This = this;
...
/*숫자에 컴마*/
GuUtil.prototype.comma = function(_num )
{
	var This = this;
...
/*객체의 위치값 및 사이즈*/
GuUtil.prototype.getPoint = function(_eId )
{
	var This = this;
	try{
...
GuUtil.prototype.getHttp = function(_method,  _url, _param, _type , _callFunction)
{
	var This = this;
 ...
 * 다음 주소 검색
 */ 
GuUtil.prototype.getPost = function(_targetPost, _targetAddress )
{
	new daum.Postcode({
