...
<table class="userjoininfo">
	...
	<tr>
		...
		<td>
			사용자<input type="radio" id="user_check_seller" name="seller_check" value="0" />&nbsp;&nbsp;사업자<input type="radio" id="seller_check_seller" name="seller_check" value="1" />
		</td>
	</tr>
	...
	<tr>
		<td style="text-align:right;width:180px;"></td>
		<td>
			<input type="submit" value="보내기" />&nbsp;&nbsp;<input type="button" onclick="user_reset()" value="취소" />
		</td>
	</tr>
